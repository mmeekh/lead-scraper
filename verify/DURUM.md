...
Güncelleme: 2026-09-21T01:00:54 · istem v3-2026-09-19 · A `gemma4:12b-it-qat` · B `qwen3:8b`

## İlan çıkarımı (birincil ürün, modelsiz)

- Taranan alan adı: 4966 — kariyer sayfası bulunan **2131**, ilanı olan **997**, toplam ilan **4080**, meslek eşleşen **2970**
...
- Şirket: 538061 — çekildi 5022, bekliyor 533039, çekilemedi 0
- Çift: 1127293 — ilanlı (modele gitmedi) 3402, evet **77**, hayır 248, belirsiz 799 (ön eleme 490), bekleyen 1122767
- Son 1 saat: 1886 çift sonuçlandı, 46 evet
- Model çağrısı: A 743, B 372 · A=yes olup B bekleyen: 8
- Hız (son 24 s): A 5.8 sn/kayıt, B 5.9 sn/kayıt · disk boş 295 GB
...
|---|---|---|---|---|---|---|---|
| fahrer | aktif | 21150 | 1856 | 463 | 1393 | 67 | 4.8 |
...
| koch | aktif | 74275 | 31 | 0 | 31 | 0 | 0.0 |
...
| lager | aktif | 11152 | 240 | 2 | 238 | 1 | 0.4 |
| dispo | aktif | 10394 | 540 | 7 | 533 | 7 | 1.3 |
| kurier | aktif | 5724 | 240 | 4 | 236 | 1 | 0.4 |
...
| service | aktif | 78459 | 31 | 0 | 31 | 0 | 0.0 |
| rezeption | aktif | 24531 | 0 | 0 | 0 | 0 | - |
| reinigung | aktif | 11066 | 23 | 0 | 23 | 0 | 0.0 |
...
| produktion | aktif | 46634 | 240 | 3 | 237 | 0 | 0.0 |
| qualitat | aktif | 45837 | 0 | 0 | 0 | 0 | - |
| controlling | aktif | 25406 | 0 | 0 | 0 | 0 | - |
| seo | aktif | 23672 | 0 | 0 | 0 | 0 | - |
| grafik | aktif | 43566 | 0 | 0 | 0 | 0 | - |
| vertrieb | aktif | 48494 | 240 | 0 | 240 | 0 | 0.0 |
| verkauf | aktif | 80403 | 425 | 3 | 422 | 0 | 0.0 |
| industriekauf | aktif | 76315 | 660 | 8 | 652 | 1 | 0.2 |
